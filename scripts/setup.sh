...
# Default: http://localhost:6616 (production) or http://localhost:3000 (development)
# -----------------------------------------------------------------------------
...
# -----------------------------------------------------------------------------
# DATABASE_URL=postgres://user:password@localhost:5432/inboxorcist
...
echo "   - Add redirect URI: http://localhost:6616/auth/google/callback"
echo "   - Add your credentials to .env"
echo "   - See docs/GOOGLE_OAUTH_SETUP.md for detailed instructions"
echo ""
echo "2. Start Inboxorcist:"
echo "   docker compose up -d"
echo ""
echo "3. Open in browser:"
echo "   http://localhost:6616"
echo ""
echo "=========================================="
echo ""
