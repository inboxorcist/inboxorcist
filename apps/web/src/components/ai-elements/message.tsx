...
export const Message = ({ className, from, ...props }: MessageProps) => (
  <div
    className={cn(
      ...
      from === 'user' ? 'is-user w-full max-w-[95%] ml-auto justify-end' : 'is-assistant w-full',
      className
    )}
    {...props}
  />
...
export const MessageBranchContent = ({ children, ...props }: MessageBranchContentProps) => {
  ...
  // eslint-disable-next-line react-hooks/exhaustive-deps -- childrenArray is intentionally recalculated
