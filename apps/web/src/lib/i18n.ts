...
export const translations = {
  en: {
    ...
    "explorer.syncPending.description": "We're syncing your inbox. Once complete, you'll be able to browse and filter all your emails.",
    ...
    "getStarted.description": "Bulk delete emails that Gmail's UI can't handle. 100k+ promotions, social updates, newsletters — gone in minutes.",
  ...
  exorcist: {
    ...
    "explorer.syncPending.description": "We're sensing the spirits in your mailbox. Once the scan completes, you'll be able to browse and banish all your demons.",
    ...
    "getStarted.tagline1": "The power of delete",
    "getStarted.tagline2": "compels you",
    "getStarted.description": "Banish the demons that Gmail's UI cannot handle. 100k+ marketing demons, social phantoms, newsletters — exorcised in minutes.",
