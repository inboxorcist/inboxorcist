...
The install script automatically preserves your data directory.
...
3. **Download the new version**
   ...
   # Download new binary (example for macOS ARM64)
...
Same as binary installation — download and extract the new release.
